...
import io.komune.registry.f2.dataset.domain.command.DatasetSetImageFunction
...
fun DatasetClient.datasetSetImageFunction(): DatasetSetImageFunction = F2Function  { msgs ->
    msgs.map { (cmd, file) ->
        val httpF2Client = (client as HttpF2Client)
        httpF2Client.httpClient.submitFormWithBinaryData(
            url = "${httpF2Client.urlBase}/datasetSetImageFunction",
