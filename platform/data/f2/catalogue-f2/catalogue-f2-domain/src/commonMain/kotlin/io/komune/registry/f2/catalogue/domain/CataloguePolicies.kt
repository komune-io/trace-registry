...
object CataloguePolicies {
    ...
    fun canUpdate(authedUser: AuthedUserDTO, catalogue: CatalogueDTO?): Boolean {
    ...
    fun canDelete(authedUser: AuthedUserDTO, catalogue: CatalogueDTO?) = catalogue.isNotNullAnd {
    ...
    fun canLinkCatalogues(authedUser: AuthedUserDTO, catalogue: CatalogueDTO?): Boolean {
        return canWrite(authedUser, catalogue)
    }

    fun canLinkThemes(authedUser: AuthedUserDTO, catalogue: CatalogueDTO?): Boolean {
        return canWrite(authedUser, catalogue)
    }

    fun canLinkDatasets(authedUser: AuthedUserDTO, catalogue: CatalogueDTO?): Boolean {
        return canWrite(authedUser, catalogue)
    }

    private fun canWrite(authedUser: AuthedUserDTO, catalogue: CatalogueDTO?) = catalogue.isNotNullAnd {
