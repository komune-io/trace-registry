...
import city.smartb.registry.f2.activity.api.service.CertificateService
import city.smartb.registry.f2.activity.domain.ActivityApi
import city.smartb.registry.f2.activity.domain.command.ActivityCreateFunction
import city.smartb.registry.f2.activity.domain.command.ActivityCreatedEventDTOBase
import city.smartb.registry.f2.activity.domain.command.ActivityStepCreateFunction
import city.smartb.registry.f2.activity.domain.command.ActivityStepCreatedEventDTOBase
import city.smartb.registry.f2.activity.domain.command.ActivityStepEvidenceFulfillCommandDTOBase
import city.smartb.registry.f2.activity.domain.command.ActivityStepEvidenceFulfilledEventDTOBase
import city.smartb.registry.f2.activity.domain.command.ActivityStepFulfillFunction
import city.smartb.registry.f2.activity.domain.command.ActivityStepFulfilledEventDTOBase
import city.smartb.registry.f2.activity.domain.query.ActivityPageFunction
import city.smartb.registry.f2.activity.domain.query.ActivityStepEvidenceDownloadQuery
import city.smartb.registry.f2.activity.domain.query.ActivityStepPageFunction
