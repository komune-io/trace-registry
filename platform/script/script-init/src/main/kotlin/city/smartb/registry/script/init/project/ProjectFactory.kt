...
import city.smartb.registry.f2.activity.client.ActivityClient
import city.smartb.registry.f2.activity.client.activityClient
import city.smartb.registry.f2.activity.domain.command.ActivityStepFulfillCommandDTOBase
import city.smartb.registry.f2.project.client.ProjectClient
import city.smartb.registry.f2.project.client.projectClient
import city.smartb.registry.f2.project.domain.command.ProjectCreatedEventDTOBase
