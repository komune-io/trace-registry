...
val LocalConsultationPreparation = localConsultationProtocolActivity {
    ...
    hasConcept {
        localConsultationStep {
            ...
            description =
                "Obtain a copy of the conservation concession contract to ensure compliance " +
        ...
        localConsultationStep {
            ...
            description =
                "Develop terms of reference to guide the project's implementation and ensure " +
        ...
        localConsultationStep {
            ...
            description =
                "Present the local community component of the project to ensure that community " +
                        "interests and needs are incorporated into the project design and implementation."
        }
        localConsultationStep {
            identifier = "D103"
            name = "Community delegate minutes"
            description =
                "Obtain minutes from community delegate meetings to ensure that community interests " +
                        "and needs are being represented and addressed in the project."
        }
        localConsultationStep {
            identifier = "D104"
            name = "Concession community projects list"
            description =
                "Obtain a list of community projects within the concession to ensure that the project is " +
                        "aligned with local development priorities and needs."
        }
        localConsultationStep {
            identifier = "D105"
            name = "Forest concession local development fund budget"
            description =
                "Obtain the budget for the forest concession local development fund to ensure that project " +
        ...
        localConsultationStep {
            ...
            description =
                "Obtain minutes from the meeting to negotiate any amendments to the project protocol to ensure " +
        ...
        localConsultationStep {
            ...
            description =
                "Develop a guide for the management of the local development fund to ensure that resources are " +
                        "being allocated effectively and transparently."
        }
        localConsultationStep {
            identifier = "D108"
            name = "Community local governance members installation meeting minutes"
            description =
                "Obtain minutes from the meeting to install members of the community local governance to " +
                        "ensure that community interests and needs are being represented and addressed in the project."
        }
        localConsultationStep {
            identifier = "D109"
            name = "Community local governance internal regulation model"
            description =
                "Develop a model for the internal regulation of the community local governance to ensure " +
        ...
        localConsultationStep {
            ...
            description =
                "Obtain minutes from collaboration meetings with ethnic groups to ensure that the project is " +
        ...
        localConsultationStep {
            ...
            description =
                "Obtain the location coordinates and area shapefile for the REDD+ investment to ensure accurate " +
...
val LocalConsultationValidation = localConsultationProtocolValidationActivity {
    ...
    hasConcept {
        localConsultationStep {
            ...
            name = "CLIP"
            description =
                "Develop a Community Land Information Platform (CLIP) to ensure effective land use planning and " +
                        "management within the concession."
        }
    }
}
