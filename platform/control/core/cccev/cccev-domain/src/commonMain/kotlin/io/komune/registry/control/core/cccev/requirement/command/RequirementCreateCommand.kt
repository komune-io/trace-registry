...
interface RequirementCreateCommandDTO {
     ...
     * @example [io.komune.registry.control.core.cccev.requirement.model.Requirement.identifier]
     */
    val identifier: String?

    /**
     * Subtype used for the requirement.
     * @example [io.komune.registry.control.core.cccev.requirement.model.Requirement.kind]
     */
    val kind: RequirementKind

    /**
     * Name of the requirement.
     * @example [io.komune.registry.control.core.cccev.requirement.model.Requirement.name]
     */
    val name: String?

    /**
     * Description of the requirement.
     * @example [io.komune.registry.control.core.cccev.requirement.model.Requirement.description]
     */
    val description: String?

    /**
     * @ref [io.komune.registry.control.core.cccev.requirement.model.Requirement.type]
     */
    val type: String?

    /**
     * Sub-requirements that must be fulfilled for the requirement to be validated.
     * @example [io.komune.registry.control.core.cccev.requirement.model.Requirement.hasRequirement]
     */
    val subRequirementIds: List<RequirementId>

    /**
     * Concepts used by the requirement
     * @example [io.komune.registry.control.core.cccev.requirement.model.Requirement.hasConcept]
     */
    val conceptIds: List<InformationConceptId>

    /**
     * Evidences that must be provided for the requirement to be validated. <br/>
     * @example [io.komune.registry.control.core.cccev.requirement.model.Requirement.hasEvidenceTypeList]
     */
    val evidenceTypeIds: List<EvidenceTypeId>

    /**
     * @ref [io.komune.registry.control.core.cccev.requirement.model.Requirement.enablingCondition]
     */
    val enablingCondition: String?

    /**
     * @ref [io.komune.registry.control.core.cccev.requirement.model.Requirement.enablingConditionDependencies]
     */
    val enablingConditionDependencies: List<InformationConceptId>

    /**
     * @ref [io.komune.registry.control.core.cccev.requirement.model.Requirement.required]
     */
    val required: Boolean

    /**
     * @ref [io.komune.registry.control.core.cccev.requirement.model.Requirement.validatingCondition]
     */
    val validatingCondition: String?

    /**
     * @ref [io.komune.registry.control.core.cccev.requirement.model.Requirement.validatingConditionDependencies]
     */
    ...
    /**
     * @ref [io.komune.registry.control.core.cccev.requirement.model.Requirement.order]
     */
    val order: Int?
