...
class FlagMessageRoutingCallback(private val flagProperties: FlagProperties) : MessageRoutingCallback {
    ...
    override fun routingResult(message: Message<*>): String {
        ...
        val path = URI(uri).path // "data/cataloguePage"
        ...
        val modulePrefixFlagMap = mapOf(
            ...
            "control" to mapOf(
                ...
                "badge" to flagProperties.module.control,
                "certification" to flagProperties.module.control,
                "dataUnit" to flagProperties.module.control,
                "dcs" to flagProperties.module.control,
                "protocol" to flagProperties.module.control,
            ),
            "data" to mapOf(
