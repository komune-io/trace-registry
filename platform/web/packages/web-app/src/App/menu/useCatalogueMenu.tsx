...
function asMenu(item: CatalogueRefTree, cataloguesAll: CatalogueAll, location: Location<any>): MenuItem[] {
  ...
  console.log("asMenu item", item.identifier, item.structure, isAlias(item))
  console.log("asMenu catalogue", catalogue.identifier, catalogue.structure?.type, isAlias(catalogue))
