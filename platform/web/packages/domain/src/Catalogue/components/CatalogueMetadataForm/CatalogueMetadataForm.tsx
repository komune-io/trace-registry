...
import { CustomButton, SearchIcon, StickyContainer, useExtendedAuth } from 'components'
...
import { CataloguePaperedAutoForm } from '../CataloguePaperedAutoForm'
...
export const CatalogueMetadataForm = (props: CatalogueMetadataFormProps) => {
    ...
    const parsedFormData = useMemo(() => {
        ...
        const mapField = (field): FormComposableField => {
