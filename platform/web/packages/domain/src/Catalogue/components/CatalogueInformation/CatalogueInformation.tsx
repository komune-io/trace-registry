...
import { LexicalEditor, TitleDivider } from 'components';
        ...
        <>
            ...
            >
                <Stack
                    ...
                    flexGrow={1}
                >
                    <LexicalEditor readOnly markdown={placeholderSection} />
                </Stack>
                <CatalogueDetails
                    catalogue={catalogue}
                    isLoading={isLoading}
...
The current editor content is styled using the [plugin](https://tailwindcss.com/docs/typography-plugin).
