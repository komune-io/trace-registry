...
export declare namespace io.komune.registry.f2.project.client {
    class ProjectClient /* implements io.komune.registry.f2.project.domain.ProjectApi */ {
        constructor(client: f2.client.F2Client);
    }
}
export declare namespace io.komune.registry.f2.project.client {
    function projectClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<io.komune.registry.f2.project.client.ProjectClient>;
}
export as namespace io_komune_registry_project_f2_client;