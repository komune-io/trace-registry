...
export namespace city.smartb.registry.f2.activity.domain.command {
    interface ActivityCreateCommandDTO {
        ...
        readonly name: string;
        readonly description?: string;
        readonly hasActivity?: Array<city.smartb.registry.f2.activity.domain.command.ActivityCreateCommandDTO>;
        readonly hasStep?: Array<city.smartb.registry.f2.activity.domain.command.ActivityStepCreateCommandDTO>;
...
export namespace city.smartb.registry.f2.activity.domain.model {
    interface ActivityDTO {
        ...
        readonly hasRequirement: city.smartb.registry.f2.activity.domain.model.ActivityDTO[];
...
export namespace city.smartb.registry.f2.activity.domain.policy {
...
export namespace city.smartb.registry.f2.activity.domain.query {
    ...
    interface ActivityPageResultDTO extends f2.dsl.cqrs.page.PageDTO<city.smartb.registry.f2.activity.domain.model.ActivityDTO> {
        readonly total: number;
        readonly items: city.smartb.registry.f2.activity.domain.model.ActivityDTO[];
...
export namespace city.smartb.registry.f2.activity.domain.query {
    ...
    interface ActivityStepPageResultDTO extends f2.dsl.cqrs.page.PageDTO<city.smartb.registry.f2.activity.domain.model.ActivityStepDTO> {
        readonly total: number;
        readonly items: city.smartb.registry.f2.activity.domain.model.ActivityStepDTO[];

    }
}
export namespace city.smartb.registry.f2.activity.client {
    class ActivityClient /* implements city.smartb.registry.f2.activity.domain.ActivityApi */ {
        constructor(client: f2.client.F2Client);
        get client(): f2.client.F2Client;
    }
}
export namespace city.smartb.registry.f2.activity.client {
    function activityClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<city.smartb.registry.f2.activity.client.ActivityClient>;
}
export as namespace registry_activity_f2_client;