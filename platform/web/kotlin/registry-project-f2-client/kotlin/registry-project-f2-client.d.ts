...
export namespace city.smartb.im.f2.organization.domain.policies {
    const OrganizationPolicies: {
        ...
        canUpdateStatus(authedUser: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
...
export namespace city.smartb.registry.s2.commons.auth {
    const Roles: {
...
export namespace city.smartb.registry.s2.commons.model {
...
export namespace city.smartb.registry.s2.asset.domain.automate {
    ...
    interface AssetPoolEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string>, s2.dsl.automate.model.WithS2Id<string>/*, city.smartb.registry.s2.commons.model.S2SourcingEvent<string> */ {
        s2Id(): string;
        readonly id: string;
...
export namespace city.smartb.registry.s2.asset.domain.automate {
    ...
    interface AssetTransactionEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string>, s2.dsl.automate.model.WithS2Id<string>/*, city.smartb.registry.s2.commons.model.S2SourcingEvent<string> */ {
        s2Id(): string;
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.asset.domain.command.pool {
    interface AssetPoolCloseCommandDTO extends city.smartb.registry.s2.asset.domain.automate.AssetPoolCommand {
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.asset.domain.command.pool {
    interface AssetPoolHoldCommandDTO extends city.smartb.registry.s2.asset.domain.automate.AssetPoolCommand {
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.asset.domain.command.pool {
    interface AssetPoolResumeCommandDTO extends city.smartb.registry.s2.asset.domain.automate.AssetPoolCommand {
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.asset.domain.model {
...
export namespace city.smartb.registry.s2.project.domain.automate {
    ...
    interface ProjectEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string>, s2.dsl.automate.model.WithS2Id<string>/*, city.smartb.registry.s2.commons.model.S2SourcingEvent<string> */ {
        s2Id(): string;
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.project.domain.command {
    interface ProjectAddAssetPoolCommandDTO extends city.smartb.registry.s2.project.domain.automate.ProjectCommand {
        readonly id: string;

    }
    interface ProjectAddedAssetPoolEventDTO extends city.smartb.registry.s2.project.domain.automate.ProjectEvent {
        readonly id: string;
...
export namespace city.smartb.registry.s2.project.domain.command {
    interface ProjectChangePrivacyCommandDTO extends city.smartb.registry.s2.project.domain.automate.ProjectCommand {
        readonly id: string;

    }
    interface ProjectChangedPrivacyEventDTO extends city.smartb.registry.s2.project.domain.automate.ProjectEvent {
        readonly id: string;
...
export namespace city.smartb.registry.s2.project.domain.command {
    interface ProjectCreateCommandDTO /* extends city.smartb.registry.s2.project.domain.command.ProjectAbstractMsg */ {
        isPrivate: Nullable<boolean>;

    }
    interface ProjectCreatedEventDTO extends city.smartb.registry.s2.project.domain.automate.ProjectEvent/*, city.smartb.registry.s2.project.domain.command.ProjectAbstractMsg */ {
        readonly id: string;
        isPrivate: Nullable<boolean>;
        s2Id(): string;
...
export namespace city.smartb.registry.s2.project.domain.command {
    interface ProjectDeleteCommandDTO extends city.smartb.registry.s2.project.domain.automate.ProjectCommand {
        readonly id: string;

    }
    interface ProjectDeletedEventDTO extends city.smartb.registry.s2.project.domain.automate.ProjectEvent {
        readonly id: string;
        s2Id(): string;
...
export namespace city.smartb.registry.s2.project.domain.command {
    interface ProjectUpdateCommandDTO /* extends city.smartb.registry.s2.project.domain.command.ProjectAbstractMsg */ {

    }
    interface ProjectUpdatedEventDTO extends city.smartb.registry.s2.project.domain.automate.ProjectEvent/*, city.smartb.registry.s2.project.domain.command.ProjectAbstractMsg */ {
        readonly id: string;
        s2Id(): string;
...
export namespace city.smartb.registry.f2.project.domain.command {
    interface ProjectAddAssetPoolCommandDTO extends city.smartb.registry.s2.project.domain.command.ProjectAddAssetPoolCommandDTO {
        readonly id: string;

    }
    interface ProjectAddedAssetPoolEventDTO extends city.smartb.registry.s2.project.domain.command.ProjectAddedAssetPoolEventDTO {
        readonly id: string;
...
export namespace city.smartb.registry.f2.project.domain.command {
    interface ProjectChangePrivacyCommandDTO extends city.smartb.registry.s2.project.domain.command.ProjectChangePrivacyCommandDTO {
        readonly id: string;

    }
    interface ProjectChangedPrivacyEventDTO extends city.smartb.registry.s2.project.domain.command.ProjectChangedPrivacyEventDTO {
        readonly id: string;
        readonly date: number;
        readonly isPrivate: boolean;
        s2Id(): string;
...
export namespace city.smartb.registry.f2.project.domain.command {
    interface ProjectCreateCommandDTO extends city.smartb.registry.s2.project.domain.command.ProjectCreateCommandDTO {
        isPrivate: Nullable<boolean>;

    }
    interface ProjectCreatedEventDTO extends city.smartb.registry.s2.project.domain.command.ProjectCreatedEventDTO {
        readonly id: string;
        isPrivate: Nullable<boolean>;
        s2Id(): string;
...
export namespace city.smartb.registry.f2.project.domain.command {
    interface ProjectDeleteCommandDTO extends city.smartb.registry.s2.project.domain.command.ProjectDeleteCommandDTO {
        readonly id: string;

    }
    interface ProjectDeletedEventDTO extends city.smartb.registry.s2.project.domain.command.ProjectDeletedEventDTO {
        readonly id: string;
        s2Id(): string;
...
export namespace city.smartb.registry.f2.project.domain.command {
    interface ProjectUpdateCommandDTO extends city.smartb.registry.s2.project.domain.command.ProjectUpdateCommandDTO {

    }
    interface ProjectUpdatedEventDTO extends city.smartb.registry.s2.project.domain.command.ProjectUpdatedEventDTO {
        readonly id: string;
        s2Id(): string;

    }
}
export namespace city.smartb.registry.f2.project.domain.model {
    interface ProjectDTO extends s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.s2.project.domain.automate.ProjectState */>, s2.dsl.automate.model.WithS2Id<string> {
        readonly id: string;
        readonly identifier?: string;
        readonly name?: string;
        ...
        readonly proponent?: city.smartb.registry.s2.project.domain.model.OrganizationRefDTO/* Nullable<city.smartb.registry.s2.project.domain.model.OrganizationRef> */;
        readonly type?: number;
        readonly referenceYear?: string;
        readonly registrationDate?: number;
        readonly vintage: string[];
        readonly slug?: string;
        readonly vvb?: city.smartb.registry.s2.project.domain.model.OrganizationRefDTO/* Nullable<city.smartb.registry.s2.project.domain.model.OrganizationRef> */;
        readonly assessor?: city.smartb.registry.s2.project.domain.model.OrganizationRefDTO/* Nullable<city.smartb.registry.s2.project.domain.model.OrganizationRef> */;
        readonly location?: city.smartb.registry.s2.commons.model.GeoLocationDTO;
        readonly activities?: string[];
        readonly certificationId?: string;
        readonly status: s2.dsl.automate.S2State/* city.smartb.registry.s2.project.domain.automate.ProjectState */;
        readonly creationDate: number;
        readonly lastModificationDate: number;
        readonly sdgs?: number[];
        readonly assetPools: string[];
        readonly isPrivate: boolean;
        s2State(): s2.dsl.automate.S2State/* city.smartb.registry.s2.project.domain.automate.ProjectState */;
        s2Id(): string;

    }
}
export namespace city.smartb.registry.f2.project.domain.query {
...
export namespace city.smartb.registry.f2.project.domain.query {
    ...
    interface ProjectGetByIdentifierResultDTO {
        readonly item?: city.smartb.registry.f2.project.domain.model.ProjectDTO;
...
export namespace city.smartb.registry.f2.project.domain.query {
    ...
    interface ProjectPageResultDTO extends f2.dsl.cqrs.page.PageQueryResultDTO<city.smartb.registry.f2.project.domain.model.ProjectDTO> {
        readonly total: number;
        readonly items: city.smartb.registry.f2.project.domain.model.ProjectDTO[];
        readonly pagination?: f2.dsl.cqrs.page.OffsetPaginationDTO;

    }
}
export namespace city.smartb.registry.f2.project.domain.utils {
    const ProjectPolicies: {
        canGet(authedUser?: city.smartb.im.commons.auth.AuthedUserDTO, project: city.smartb.registry.f2.project.domain.model.ProjectDTO): boolean;
        canList(authedUser?: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
        privateOrganizationId(authedUser?: city.smartb.im.commons.auth.AuthedUserDTO): Nullable<string>;
        canCreate(authedUser: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
        canUpdate(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, project: city.smartb.registry.f2.project.domain.model.ProjectDTO): boolean;
        canDelete(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, project: city.smartb.registry.f2.project.domain.model.ProjectDTO): boolean;
    };
}
export namespace city.smartb.registry.f2.project.client {
    class ProjectClient /* implements city.smartb.registry.f2.project.domain.ProjectApi */ {
        constructor(client: f2.client.F2Client);
    }
}
export namespace city.smartb.registry.f2.project.client {
    function projectClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<city.smartb.registry.f2.project.client.ProjectClient>;
}
export as namespace registry_project_f2_client;