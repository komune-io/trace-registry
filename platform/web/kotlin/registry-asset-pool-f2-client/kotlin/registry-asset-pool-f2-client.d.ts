...
export namespace city.smartb.registry.f2.asset.pool.domain.command {
    interface AssetIssueCommandDTO /* extends city.smartb.registry.f2.asset.pool.domain.command.AbstractAssetTransactionCommand */ {
...
export namespace city.smartb.registry.f2.asset.pool.domain.command {
    interface AssetPoolCloseCommandDTO extends city.smartb.registry.s2.asset.domain.command.pool.AssetPoolCloseCommandDTO {
        readonly id: string;
...
export namespace city.smartb.registry.f2.asset.pool.domain.command {
    interface AssetPoolHoldCommandDTO extends city.smartb.registry.s2.asset.domain.command.pool.AssetPoolHoldCommandDTO {
        readonly id: string;
...
export namespace city.smartb.registry.f2.asset.pool.domain.command {
    interface AssetPoolResumeCommandDTO extends city.smartb.registry.s2.asset.domain.command.pool.AssetPoolResumeCommandDTO {
        readonly id: string;
...
export namespace city.smartb.registry.f2.asset.pool.domain.model {
    interface AssetPoolDTO extends s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.s2.asset.domain.automate.AssetPoolState */> {
        readonly id: string;
        readonly status: string;
        readonly vintage?: string;
        ...
        readonly stats: city.smartb.registry.s2.asset.domain.model.AssetPoolStats;
        readonly metadata: Record<string, Nullable<string>>;
        s2State(): s2.dsl.automate.S2State/* city.smartb.registry.s2.asset.domain.automate.AssetPoolState */;

    }
}
export namespace city.smartb.registry.f2.asset.pool.domain.model {
    interface AssetTransactionDTO extends s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.s2.asset.domain.automate.AssetTransactionState */> {
        readonly id: string;
        ...
        readonly status: string;
        s2State(): s2.dsl.automate.S2State/* city.smartb.registry.s2.asset.domain.automate.AssetTransactionState */;

    }
}
export namespace city.smartb.registry.f2.asset.pool.domain.query {
...
export namespace city.smartb.registry.f2.asset.pool.domain.query {
    ...
    interface AssetPoolGetResultDTO {
        readonly item?: city.smartb.registry.f2.asset.pool.domain.model.AssetPoolDTO;
...
export namespace city.smartb.registry.f2.asset.pool.domain.query {
    ...
    interface AssetPoolPageResultDTO extends f2.dsl.cqrs.page.PageQueryResultDTO<city.smartb.registry.f2.asset.pool.domain.model.AssetPoolDTO> {
        readonly total: number;
        readonly items: city.smartb.registry.f2.asset.pool.domain.model.AssetPoolDTO[];
        readonly pagination?: f2.dsl.cqrs.page.OffsetPaginationDTO;
...
export namespace city.smartb.registry.f2.asset.pool.domain.query {
    ...
    interface AssetTransactionGetResultDTO {
        readonly item?: city.smartb.registry.f2.asset.pool.domain.model.AssetTransactionDTO;
...
export namespace city.smartb.registry.f2.asset.pool.domain.query {
    ...
    interface AssetTransactionPageResultDTO extends f2.dsl.cqrs.page.PageDTO<city.smartb.registry.f2.asset.pool.domain.model.AssetTransactionDTO> {
        readonly total: number;
        readonly items: city.smartb.registry.f2.asset.pool.domain.model.AssetTransactionDTO[];

    }
}
export namespace city.smartb.registry.f2.asset.pool.domain.utils {
    const AssetPoolPolicies: {
        canList(authedUser?: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
        canCreate(authedUser: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
        canHold(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, assetPool: city.smartb.registry.f2.asset.pool.domain.model.AssetPoolDTO): boolean;
        canResume(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, assetPool: city.smartb.registry.f2.asset.pool.domain.model.AssetPoolDTO): boolean;
        canClose(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, assetPool: city.smartb.registry.f2.asset.pool.domain.model.AssetPoolDTO): boolean;
...
export namespace city.smartb.registry.f2.asset.pool.client {
    class AssetPoolClient /* implements city.smartb.registry.f2.asset.pool.domain.AssetPoolApi */ {
        constructor(client: f2.client.F2Client);
    }
}
export namespace city.smartb.registry.f2.asset.pool.client {
    function assetPoolClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<city.smartb.registry.f2.asset.pool.client.AssetPoolClient>;
}
export as namespace registry_asset_pool_f2_client;