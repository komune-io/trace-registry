...
export namespace city.smartb.registry.program.f2.project.domain.command {
    interface ProjectAddAssetPoolCommandDTO extends city.smartb.registry.program.s2.project.domain.command.ProjectAddAssetPoolCommandDTO {
        readonly id: string;

    }
    interface ProjectAddedAssetPoolEventDTO extends city.smartb.registry.program.s2.project.domain.command.ProjectAddedAssetPoolEventDTO {
        readonly id: string;
...
export namespace city.smartb.registry.program.f2.project.domain.command {
    interface ProjectChangePrivacyCommandDTO extends city.smartb.registry.program.s2.project.domain.command.ProjectChangePrivacyCommandDTO {
        readonly id: string;

    }
    interface ProjectChangedPrivacyEventDTO extends city.smartb.registry.program.s2.project.domain.command.ProjectChangedPrivacyEventDTO {
        readonly id: string;
        readonly date: number;
        readonly isPrivate: boolean;
        s2Id(): string;
...
export namespace city.smartb.registry.program.f2.project.domain.utils {
    const ProjectPolicies: {
        canGet(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, project: city.smartb.registry.program.s2.project.domain.model.ProjectDTO): boolean;
        canList(authedUser: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
