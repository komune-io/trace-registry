...
export namespace city.smartb.registry.f2.dataset.client {
    class DatasetClient /* implements city.smartb.registry.f2.dataset.domain.DatasetApi */ {
        constructor(client: f2.client.F2Client);
        get client(): f2.client.F2Client;
    }
}
export namespace city.smartb.registry.f2.dataset.client {
    function datasetClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<city.smartb.registry.f2.dataset.client.DatasetClient>;
}
export as namespace registry_dataset_f2_client;