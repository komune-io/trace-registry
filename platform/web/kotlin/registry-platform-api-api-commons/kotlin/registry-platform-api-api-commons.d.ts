...
export declare namespace io.komune.registry.api.commons.exception {
    const ExceptionCodes: {
...
export declare namespace io.komune.registry.api.commons.model {
    const RedirectableRoutes: {
        quotations(): string;
        projects(): string;
    };
}
export as namespace io_komune_registry_api_commons;