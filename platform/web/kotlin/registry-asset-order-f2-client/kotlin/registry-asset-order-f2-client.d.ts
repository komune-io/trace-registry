...
export namespace city.smartb.registry.s2.order.domain {
    ...
    interface OrderEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string>, s2.dsl.automate.model.WithS2Id<string>/*, city.smartb.registry.s2.commons.model.S2SourcingEvent<string> */ {
        s2Id(): string;
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.order.domain.command {
    interface OrderCancelCommandDTO extends city.smartb.registry.s2.order.domain.OrderCommand {
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.order.domain.command {
    interface OrderDeleteCommandDTO extends city.smartb.registry.s2.order.domain.OrderCommand {
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.order.domain.command {
    interface OrderPlaceCommandDTO extends city.smartb.registry.s2.order.domain.OrderInitCommand {
        readonly from?: string;
        readonly to?: string;
        readonly by: string;
        readonly poolId?: string;
        readonly quantity: number;
        readonly type: city.smartb.registry.s2.asset.domain.model.AssetTransactionType;

    }
}
export namespace city.smartb.registry.s2.order.domain.command {
    interface OrderSubmitCommandDTO extends city.smartb.registry.s2.order.domain.OrderCommand {
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.order.domain.command {
    interface OrderUpdateCommandDTO extends city.smartb.registry.s2.order.domain.OrderCommand {
        readonly id: string;
        readonly poolId?: string;
        readonly quantity: number;
...
export namespace city.smartb.registry.f2.asset.order.domain.command {
    interface AssetOrderCancelCommandDTO extends city.smartb.registry.s2.order.domain.command.OrderCancelCommandDTO {
        readonly id: string;
...
export namespace city.smartb.registry.f2.asset.order.domain.command {
    interface AssetOrderDeleteCommandDTO extends city.smartb.registry.s2.order.domain.command.OrderDeleteCommandDTO {
        readonly id: string;
...
export namespace city.smartb.registry.f2.asset.order.domain.command {
    interface AssetOrderPlaceCommandDTO extends city.smartb.registry.s2.order.domain.command.OrderPlaceCommandDTO {
        readonly from?: string;
        readonly to?: string;
        readonly by: string;
        readonly poolId?: string;
...
export namespace city.smartb.registry.f2.asset.order.domain.command {
    interface AssetOrderSubmitCommandDTO extends city.smartb.registry.s2.order.domain.command.OrderSubmitCommandDTO {
        readonly id: string;
...
export namespace city.smartb.registry.f2.asset.order.domain.command {
    interface AssetOrderUpdateCommandDTO extends city.smartb.registry.s2.order.domain.command.OrderUpdateCommandDTO {
        readonly id: string;
        readonly poolId?: string;
        readonly quantity: number;
...
export namespace city.smartb.registry.f2.asset.order.domain.model {
    interface OrderDTO extends s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.s2.asset.domain.automate.AssetTransactionState */> {
        readonly id: string;
        readonly status: string;
        readonly poolId?: string;
        readonly from?: string;
...
export namespace city.smartb.registry.f2.asset.order.domain.query {
    interface AssetOrderGetQueryDTO {
        readonly id: string;

    }
    interface AssetOrderGetResultDTO {
        readonly item?: city.smartb.registry.f2.asset.order.domain.model.OrderDTO;
...
export namespace city.smartb.registry.f2.asset.order.domain.query {
    ...
    interface AssetOrderPageResultDTO extends f2.dsl.cqrs.page.PageQueryResultDTO<city.smartb.registry.f2.asset.order.domain.model.OrderDTO> {
        readonly total: number;
        readonly items: city.smartb.registry.f2.asset.order.domain.model.OrderDTO[];
        readonly pagination?: f2.dsl.cqrs.page.OffsetPaginationDTO;

    }
}
export namespace city.smartb.registry.f2.asset.order.domain.utils {
    const AssetPolicies: {
        canGetOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
        canListOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
        canPlaceOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO): boolean;
        canSubmitOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, order: city.smartb.registry.f2.asset.order.domain.model.OrderDTO): boolean;
        canUpdateOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, order: city.smartb.registry.f2.asset.order.domain.model.OrderDTO): boolean;
        canCompleteOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, order: city.smartb.registry.f2.asset.order.domain.model.OrderDTO): boolean;
        canCancelOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, order: city.smartb.registry.f2.asset.order.domain.model.OrderDTO): boolean;
        canDeleteOrder(authedUser: city.smartb.im.commons.auth.AuthedUserDTO, order: city.smartb.registry.f2.asset.order.domain.model.OrderDTO): boolean;
    };
}
export namespace city.smartb.registry.f2.asset.order.domain.utils {
...
export namespace city.smartb.registry.f2.asset.pool.client {
    class AssetClient /* implements city.smartb.registry.f2.asset.order.domain.AssetOrderApi */ {
        constructor(client: f2.client.F2Client);
    }
}
export namespace city.smartb.registry.f2.asset.pool.client {
    function assetClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<city.smartb.registry.f2.asset.pool.client.AssetClient>;
}
export as namespace registry_asset_order_f2_client;