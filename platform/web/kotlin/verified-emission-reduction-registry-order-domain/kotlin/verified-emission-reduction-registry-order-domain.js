...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['@js-joda/core'] === 'undefined') {
      throw new Error("Error loading module 'verified-emission-reduction-registry-order-domain'. Its dependency '@js-joda/core' was not found. Please, check whether '@js-joda/core' is loaded prior to 'verified-emission-reduction-registry-order-domain'.");
    }
    root['verified-emission-reduction-registry-order-domain'] = factory(typeof this['verified-emission-reduction-registry-order-domain'] === 'undefined' ? {} : this['verified-emission-reduction-registry-order-domain'], this['@js-joda/core']);
  }
  ...
  setMetadataFor(ExceptionCodes_0, 'ExceptionCodes', objectMeta, undefined, undefined, undefined, undefined, []);
  ...
  setMetadataFor(OrderPlaceCommandDTO, 'OrderPlaceCommandDTO', interfaceMeta, undefined, [OrderInitCommand], undefined, undefined, []);
  ...
  function AuthRealm(serverUrl, realmId, clientId, redirectUrl, space) {
    ...
    this.pr_1 = realmId;
    this.qr_1 = clientId;
    this.rr_1 = redirectUrl;
    this.sr_1 = space;
  }
  AuthRealm.prototype.tr = function () {
    return this.nr_1;
  };
  AuthRealm.prototype.ur = function () {
    return this.pr_1;
  };
  AuthRealm.prototype.vr = function () {
    return this.qr_1;
  };
  AuthRealm.prototype.wr = function () {
    return this.rr_1;
  };
  AuthRealm.prototype.xr = function () {
    return this.sr_1;
  };
  ...
  function AuthRealmPassword(serverUrl, realmId, redirectUrl, clientId, username, password, space) {
    ...
    this.ds_1 = serverUrl;
    this.es_1 = realmId;
    this.fs_1 = redirectUrl;
    this.gs_1 = clientId;
    this.username = username;
    this.password = password;
    this.hs_1 = space;
  }
  AuthRealmPassword.prototype.tr = function () {
    return this.ds_1;
  };
  AuthRealmPassword.prototype.ur = function () {
    return this.es_1;
  };
  AuthRealmPassword.prototype.wr = function () {
    return this.fs_1;
  };
  AuthRealmPassword.prototype.vr = function () {
    return this.gs_1;
  };
  AuthRealmPassword.prototype.is = function () {
    return this.username;
  };
  AuthRealmPassword.prototype.js = function () {
    return this.password;
  };
  AuthRealmPassword.prototype.xr = function () {
    return this.hs_1;
  };
  ...
  AuthRealmPassword.prototype.copy = function (serverUrl, realmId, redirectUrl, clientId, username, password, space) {
    return this.ks(serverUrl === void 1 ? this.ds_1 : serverUrl, realmId === void 1 ? this.es_1 : realmId, redirectUrl === void 1 ? this.fs_1 : redirectUrl, clientId === void 1 ? this.gs_1 : clientId, username === void 1 ? this.username : username, password === void 1 ? this.password : password, space === void 1 ? this.hs_1 : space);
  };
  AuthRealmPassword.prototype.ks = function (serverUrl, realmId, redirectUrl, clientId, username, password, space) {
    return new AuthRealmPassword(serverUrl, realmId, redirectUrl, clientId, username, password, space);
  };
  AuthRealmPassword.prototype.ls = function (serverUrl, realmId, redirectUrl, clientId, username, password, space, $mask0, $handler) {
    if (!(($mask0 & 1) === 0))
      serverUrl = this.ds_1;
    if (!(($mask0 & 2) === 0))
      realmId = this.es_1;
    if (!(($mask0 & 4) === 0))
      redirectUrl = this.fs_1;
    if (!(($mask0 & 8) === 0))
      clientId = this.gs_1;
    if (!(($mask0 & 16) === 0))
    ...
    if (!(($mask0 & 64) === 0))
      space = this.hs_1;
    return this.ks(serverUrl, realmId, redirectUrl, clientId, username, password, space);
  };
  AuthRealmPassword.prototype.toString = function () {
    return 'AuthRealmPassword(serverUrl=' + this.ds_1 + ', realmId=' + this.es_1 + ', redirectUrl=' + this.fs_1 + ', clientId=' + this.gs_1 + ', username=' + this.username + ', password=' + this.password + ', space=' + this.hs_1 + ')';
  };
  AuthRealmPassword.prototype.hashCode = function () {
    var result = getStringHashCode(this.ds_1);
    result = imul(result, 31) + getStringHashCode(this.es_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.fs_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.gs_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.username) | 0;
    result = imul(result, 31) + getStringHashCode(this.password) | 0;
    result = imul(result, 31) + getStringHashCode(this.hs_1) | 0;
    return result;
  };
  AuthRealmPassword.prototype.equals = function (other) {
    ...
    if (!(this.ds_1 === tmp0_other_with_cast.ds_1))
      return false;
    if (!(this.es_1 === tmp0_other_with_cast.es_1))
      return false;
    if (!(this.fs_1 === tmp0_other_with_cast.fs_1))
      return false;
    if (!(this.gs_1 === tmp0_other_with_cast.gs_1))
      return false;
    if (!(this.username === tmp0_other_with_cast.username))
      return false;
    if (!(this.password === tmp0_other_with_cast.password))
      return false;
    if (!(this.hs_1 === tmp0_other_with_cast.hs_1))
      return false;
    return true;
  };
  function AuthRealmClientSecret(serverUrl, realmId, clientId, redirectUrl, clientSecret, space) {
    ...
    this.ss_1 = realmId;
    this.ts_1 = clientId;
    this.us_1 = redirectUrl;
    this.clientSecret = clientSecret;
    this.vs_1 = space;
  }
  AuthRealmClientSecret.prototype.tr = function () {
    return this.rs_1;
  };
  AuthRealmClientSecret.prototype.ur = function () {
    return this.ss_1;
  };
  AuthRealmClientSecret.prototype.vr = function () {
    return this.ts_1;
  };
  AuthRealmClientSecret.prototype.wr = function () {
    return this.us_1;
  };
  AuthRealmClientSecret.prototype.ws = function () {
    return this.clientSecret;
  };
  AuthRealmClientSecret.prototype.xr = function () {
    return this.vs_1;
  };
  ...
  AuthRealmClientSecret.prototype.copy = function (serverUrl, realmId, clientId, redirectUrl, clientSecret, space) {
    return this.xs(serverUrl === void 1 ? this.rs_1 : serverUrl, realmId === void 1 ? this.ss_1 : realmId, clientId === void 1 ? this.ts_1 : clientId, redirectUrl === void 1 ? this.us_1 : redirectUrl, clientSecret === void 1 ? this.clientSecret : clientSecret, space === void 1 ? this.vs_1 : space);
  };
  AuthRealmClientSecret.prototype.xs = function (serverUrl, realmId, clientId, redirectUrl, clientSecret, space) {
    return new AuthRealmClientSecret(serverUrl, realmId, clientId, redirectUrl, clientSecret, space);
  };
  AuthRealmClientSecret.prototype.ys = function (serverUrl, realmId, clientId, redirectUrl, clientSecret, space, $mask0, $handler) {
    if (!(($mask0 & 1) === 0))
      serverUrl = this.rs_1;
    if (!(($mask0 & 2) === 0))
      realmId = this.ss_1;
    if (!(($mask0 & 4) === 0))
      clientId = this.ts_1;
    if (!(($mask0 & 8) === 0))
      redirectUrl = this.us_1;
    if (!(($mask0 & 16) === 0))
      clientSecret = this.clientSecret;
    if (!(($mask0 & 32) === 0))
      space = this.vs_1;
    return this.xs(serverUrl, realmId, clientId, redirectUrl, clientSecret, space);
  };
  AuthRealmClientSecret.prototype.toString = function () {
    return 'AuthRealmClientSecret(serverUrl=' + this.rs_1 + ', realmId=' + this.ss_1 + ', clientId=' + this.ts_1 + ', redirectUrl=' + this.us_1 + ', clientSecret=' + this.clientSecret + ', space=' + this.vs_1 + ')';
  };
  AuthRealmClientSecret.prototype.hashCode = function () {
    var result = getStringHashCode(this.rs_1);
    result = imul(result, 31) + getStringHashCode(this.ss_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.ts_1) | 0;
    result = imul(result, 31) + (this.us_1 == null ? 0 : getStringHashCode(this.us_1)) | 0;
    result = imul(result, 31) + getStringHashCode(this.clientSecret) | 0;
    result = imul(result, 31) + getStringHashCode(this.vs_1) | 0;
    return result;
  };
  AuthRealmClientSecret.prototype.equals = function (other) {
    ...
    if (!(this.rs_1 === tmp0_other_with_cast.rs_1))
      return false;
    if (!(this.ss_1 === tmp0_other_with_cast.ss_1))
      return false;
    if (!(this.ts_1 === tmp0_other_with_cast.ts_1))
      return false;
    if (!(this.us_1 == tmp0_other_with_cast.us_1))
      return false;
    if (!(this.clientSecret === tmp0_other_with_cast.clientSecret))
      return false;
    if (!(this.vs_1 === tmp0_other_with_cast.vs_1))
      return false;
    return true;
  };
  ...
  ClientJs$doCall$slambda.prototype.jt = function ($this$promise, $cont) {
    var tmp = this.kt($this$promise, $cont);
    tmp.q9_1 = Unit_getInstance();
    tmp.r9_1 = null;
    return tmp.x9();
  };
  ClientJs$doCall$slambda.prototype.ja = function (p1, $cont) {
    return this.jt((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $cont);
  };
  ...
  ClientJs$doCall$slambda.prototype.kt = function ($this$promise, completion) {
    var i = new ClientJs$doCall$slambda(this.ht_1, completion);
    i.it_1 = $this$promise;
    return i;
  };
  ...
  OrganizationStatusValues.prototype.pending = function () {
    return OrganizationStatus_PENDING_getInstance().z2_1;
  };
  OrganizationStatusValues.prototype.validated = function () {
    return OrganizationStatus_VALIDATED_getInstance().z2_1;
  };
  OrganizationStatusValues.prototype.rejected = function () {
    return OrganizationStatus_REJECTED_getInstance().z2_1;
  };
  ...
  function Block(blockId, previousHash, dataHash, transactions) {
    this.av_1 = blockId;
    this.bv_1 = previousHash;
    this.cv_1 = dataHash;
    this.dv_1 = transactions;
  }
  ...
  IdentitiesInfo.prototype.gv = function () {
    return this.iv_1;
  };
  ...
  Transaction.prototype.wu = function () {
    return this.qv_1;
  };
  ...
  Transaction.prototype.nv = function () {
    return this.vv_1;
  };
  Transaction.prototype.mt = function () {
    return this.wv_1;
  };
  ...
  ChaincodeSsmConfig.prototype.eu = function () {
    return this.yv_1;
  };
  ...
  Chaincode.prototype.lv = function () {
    return this.fw_1;
  };
  ...
  SsmTransition.prototype.ju = function () {
    return this.hy_1;
  };
  ...
  ChaincodeUri.prototype.lv = function () {
  ...
  Companion_20.prototype.my = function () {
    return this.PARTS;
  };
  Companion_20.prototype.ny = function () {
    return this.PREFIX;
  };
  ...
  SsmGetAdminResult.prototype.nt = function () {
    return this.yy_1;
  };
  ...
  SsmGetQuery.prototype.vu = function () {
    return this.zy_1;
  };
  ...
  SsmGetResult.prototype.nt = function () {
    return this.az_1;
  };
  ...
  SsmGetSessionLogsQuery.prototype.vu = function () {
    return this.bz_1;
  };
  ...
  SsmGetSessionQuery.prototype.vu = function () {
    return this.gz_1;
  };
  ...
  SsmGetSessionResult.prototype.nt = function () {
    return this.hz_1;
  };
  ...
  SsmGetTransactionQuery.prototype.vu = function () {
    return this.iz_1;
  };
  ...
  SsmGetTransactionQueryResult.prototype.nt = function () {
    return this.lz_1;
  };
  ...
  SsmGetUserQuery.prototype.vu = function () {
    return this.mz_1;
  };
  ...
  SsmGetUserResult.prototype.nt = function () {
    return this.nz_1;
  };
  ...
  SsmListAdminQuery.prototype.vu = function () {
    return this.oz_1;
  };
  ...
  SsmListSessionQuery.prototype.vu = function () {
    return this.qz_1;
  };
  ...
  SsmListSsmQuery.prototype.vu = function () {
    return this.sz_1;
  };
  ...
  SsmListUserQuery.prototype.vu = function () {
    return this.uz_1;
  };
  ...
  S2ErrorBase.prototype.mt = function () {
    return this.b10_1;
  };
  S2ErrorBase.prototype.lt = function () {
    return this.c10_1;
  };
  ...
  S2EventSuccess.prototype.mt = function () {
    return this.type;
  };
  ...
  S2EventError.prototype.mt = function () {
    return this.type;
  };
  ...
  S2SubMachine.prototype.q10 = function () {
    return this.k10_1;
  };
  ...
  S2InitTransition.prototype.ju = function () {
    return this.t10_1;
  };
  ...
  S2Transition.prototype.ju = function () {
    return this.z10_1;
  };
  ...
  function ExceptionCodes_0() {
    ExceptionCodes_instance_0 = this;
  }
  ExceptionCodes_0.prototype.negativeTransaction = function () {
    return 1000;
  };
  ExceptionCodes_0.prototype.notEnoughAssets = function () {
    return 1001;
  };
  ExceptionCodes_0.prototype.granularityTooSmall = function () {
    return 1002;
  };
  var ExceptionCodes_instance_0;
  function ExceptionCodes_getInstance_0() {
    if (ExceptionCodes_instance_0 == null)
      new ExceptionCodes_0();
    return ExceptionCodes_instance_0;
  }
  ...
  $serializer_10.prototype.ep = function (decoder) {
    var tmp0_desc = this.h12_1;
    var tmp1_flag = true;
    var tmp2_index = 0;
    var tmp3_bitMask0 = 0;
    var tmp4_input = decoder.fp(tmp0_desc);
    if (tmp4_input.yk()) {
    } else
      while (tmp1_flag) {
        tmp2_index = tmp4_input.zk(tmp0_desc);
        if (tmp2_index === -1)
          tmp1_flag = false;
        else
          throw UnknownFieldException_init_$Create$(tmp2_index);
  ...
  $serializer_10.prototype.i12 = function (encoder, value) {
    var tmp0_desc = this.h12_1;
    var tmp1_output = encoder.fp(tmp0_desc);
    tmp1_output.xk(tmp0_desc);
  };
  $serializer_10.prototype.hp = function (encoder, value) {
    return this.i12(encoder, value instanceof CoreLocationLocation ? value : THROW_CCE());
  };
  ...
  function CoreLocationLocation_init_$Init$(seen1, serializationConstructorMarker, $this) {
    if (!(0 === (0 & seen1))) {
      throwMissingFieldException(seen1, 0, $serializer_getInstance_8().h12_1);
    }
    return $this;
  }
  ...
  $serializer_11.prototype.ep = function (decoder) {
    ...
    var tmp7_input = decoder.fp(tmp0_desc);
    if (tmp7_input.yk()) {
      tmp4_local0 = tmp7_input.dl(tmp0_desc, 0, StringSerializer_getInstance(), tmp4_local0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp7_input.dl(tmp0_desc, 1, IntSerializer_getInstance(), tmp5_local1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
      tmp6_local2 = tmp7_input.dl(tmp0_desc, 2, IntSerializer_getInstance(), tmp6_local2);
      tmp3_bitMask0 = tmp3_bitMask0 | 4;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp7_input.zk(tmp0_desc);
  ...
  $serializer_11.prototype.k12 = function (encoder, value) {
    var tmp0_desc = this.j12_1;
    var tmp1_output = encoder.fp(tmp0_desc);
    ...
    if (tmp1_output.el(tmp0_desc, 1) ? true : !(value.endTime == null)) {
      tmp1_output.il(tmp0_desc, 1, IntSerializer_getInstance(), value.endTime);
    }
    if (tmp1_output.el(tmp0_desc, 2) ? true : !(value.startTime == null)) {
      tmp1_output.il(tmp0_desc, 2, IntSerializer_getInstance(), value.startTime);
    }
    tmp1_output.xk(tmp0_desc);
  };
  $serializer_11.prototype.hp = function (encoder, value) {
    return this.k12(encoder, value instanceof PeriodOfTime ? value : THROW_CCE());
  };
  ...
  function PeriodOfTime_init_$Init$_0(seen1, duration, endTime, startTime, serializationConstructorMarker, $this) {
    if (!(0 === (0 & seen1))) {
      throwMissingFieldException(seen1, 0, $serializer_getInstance_9().j12_1);
    }
    if (0 === (seen1 & 1))
      $this.duration = null;
    else
  ...
  PeriodOfTime.prototype.l12 = function () {
    return this.duration;
  };
  PeriodOfTime.prototype.m12 = function () {
    return this.endTime;
  };
  PeriodOfTime.prototype.n12 = function () {
  ...
  DataUnitTypeValues.prototype.boolean = function () {
    return DataUnitType_BOOLEAN_getInstance().z2_1;
  };
  DataUnitTypeValues.prototype.date = function () {
    return DataUnitType_DATE_getInstance().z2_1;
  };
  DataUnitTypeValues.prototype.number = function () {
    return DataUnitType_NUMBER_getInstance().z2_1;
  };
  DataUnitTypeValues.prototype.string = function () {
    return DataUnitType_STRING_getInstance().z2_1;
  };
  ...
  $serializer_10.prototype.nm = typeParametersSerializers;
  $serializer_11.prototype.nm = typeParametersSerializers;
  //endregion
  //region block: init
  MODE_CANCELLABLE = 1;
  ...
  function $jsExportAll$(_) {
    ...
    $city$smartb$im$commons$auth.ImRole.values = values;
    ...
    Object.defineProperty($city$smartb$registry$program$api$commons$exception, 'ExceptionCodes', {
      configurable: true,
      get: ExceptionCodes_getInstance_0
    });
    var $city = _.city || (_.city = {});
    var $city$smartb = $city.smartb || ($city.smartb = {});
    var $city$smartb$registry = $city$smartb.registry || ($city$smartb.registry = {});
...
//# sourceMappingURL=verified-emission-reduction-registry-order-domain.js.map
