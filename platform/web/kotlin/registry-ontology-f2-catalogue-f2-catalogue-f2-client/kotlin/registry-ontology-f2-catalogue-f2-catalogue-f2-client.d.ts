...
export declare namespace io.komune.registry.f2.catalogue.client {
    class CatalogueClient /* implements io.komune.registry.f2.catalogue.domain.CatalogueApi */ {
        constructor(client: f2.client.F2Client);
        get client(): f2.client.F2Client;
    }
}
export declare namespace io.komune.registry.f2.catalogue.client {
    function catalogueClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<io.komune.registry.f2.catalogue.client.CatalogueClient>;
}
export as namespace io_komune_registry_catalogue_f2_client;