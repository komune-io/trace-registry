...
export declare namespace io.komune.registry.f2.activity.client {
    class ActivityClient /* implements io.komune.registry.f2.activity.domain.ActivityApi */ {
        constructor(client: f2.client.F2Client);
        get client(): f2.client.F2Client;
    }
}
export declare namespace io.komune.registry.f2.activity.client {
    function activityClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<io.komune.registry.f2.activity.client.ActivityClient>;
}
export as namespace io_komune_registry_activity_f2_client;