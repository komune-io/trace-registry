...
export declare namespace io.komune.registry.f2.asset.pool.client {
    class AssetClient /* implements io.komune.registry.f2.asset.order.domain.AssetOrderApi */ {
        constructor(client: f2.client.F2Client);
    }
}
export declare namespace io.komune.registry.f2.asset.pool.client {
    function assetClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<io.komune.registry.f2.asset.pool.client.AssetClient>;
}
export as namespace io_komune_registry_asset_order_f2_client;