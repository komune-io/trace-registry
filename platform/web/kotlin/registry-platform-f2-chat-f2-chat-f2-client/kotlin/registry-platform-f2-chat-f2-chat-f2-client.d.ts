...
export declare namespace io.komune.registry.f2.chat.client {
    class ChatClient /* implements io.komune.registry.f2.chat.domain.ChatApi */ {
        constructor(client: f2.client.F2Client);
    }
}
export declare namespace io.komune.registry.f2.chat.client {
    function chatClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<io.komune.registry.f2.chat.client.ChatClient>;
}
export as namespace io_komune_registry_chat_f2_client;