...
export namespace city.smartb.registry.program.f2.pool.client {
    class AssetPoolClient /* implements city.smartb.registry.program.f2.pool.domain.AssetPoolApi */ {
        constructor(client: f2.client.F2Client);
    }
}
export namespace city.smartb.registry.program.f2.pool.client {
    function assetPoolClient(urlBase: string, accessToken: string): f2.dsl.fnc.F2SupplierSingle<city.smartb.registry.program.f2.pool.client.AssetPoolClient>;
}
export as namespace verified_emission_reduction_registry_asset_pool_f2_client;