...
//
//fun AssertionBdd.certification(conceptRepository: CertificationRepositoryOld) = AssertionCertification(conceptRepository)
//
//class AssertionCertification(
//    override val repository: CertificationRepositoryOld
